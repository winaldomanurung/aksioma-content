...
import {iconSets,shapeNames} from "./assets";
...
METADATA:
meta: title, objective, contentPillar, hook, instagramCaption, tiktokCaption,
...
freeform: eyebrow?,dark?,backgroundWord?,cornerLabel?,density?,nodes:[primitive]
...
export function makeAiPrompt({topic="",audience="Young professionals",objective="Save, share dan follow",slides=10}={}) {
...
${JSON.stringify(exampleCarousel,null,2)}
