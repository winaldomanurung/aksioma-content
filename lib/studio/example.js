export const exampleCarousel = {
  ...
  slides: [
    ...
    { type: "freeform", eyebrow: "Contoh nyata", dark: false, backgroundWord: "DATA", density: "balanced", nodes: [
    ...
    { type: "freeform", eyebrow: "Latihan", dark: true, density: "balanced", backgroundWord: "TEST", nodes: [
